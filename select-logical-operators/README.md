...
ChallengeYou are given a table called cities. Return all names from the cities table where the population is less than 1,000,000 or greater than 10,000,000, and the name of the city does not start with an uppercase C.
